...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const faq0 = new FAQ({
    			props: { faqitems: /*faqstore1*/ ctx[3] },
    			$$inline: true
    		});

    	const faq1 = new FAQ({
    			props: { faqitems: /*faqstore2*/ ctx[4] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("FAQ \"");
    			t3 = text(/*name*/ ctx[0]);
    			t4 = text("\": log store of FAQs 1");
    			t5 = space();
    			li1 = element("li");
    			button1 = element("button");
    			button1.textContent = "FAQ \"Frameworks\" log store of FAQs 2";
    			t7 = space();
    			h10 = element("h1");
    			t8 = text("FAQ for \"");
    			t9 = text(/*name*/ ctx[0]);
    			...
    			add_location(button0, file$2, 47, 8, 1545);
    			attr_dev(li0, "class", "svelte-1j17dtm");
    			add_location(li0, file$2, 46, 6, 1532);
    			add_location(button1, file$2, 53, 8, 1724);
    			attr_dev(li1, "class", "svelte-1j17dtm");
    			add_location(li1, file$2, 52, 6, 1711);
    			add_location(ul, file$2, 45, 4, 1521);
    			attr_dev(div, "class", "debug svelte-1j17dtm");
    			add_location(div, file$2, 43, 2, 1478);
    			attr_dev(h10, "class", "svelte-1j17dtm");
    			add_location(h10, file$2, 67, 2, 2035);
    			attr_dev(h11, "class", "svelte-1j17dtm");
    			add_location(h11, file$2, 70, 2, 2094);
    			attr_dev(main, "class", "svelte-1j17dtm");
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	validate_store(faqstore1, "faqstore1");
    	component_subscribe($$self, faqstore1, value => $$invalidate(1, $faqstore1 = value));
    	const faqstore2 = createFAQItems(faqitems_frameworks);
    	validate_store(faqstore2, "faqstore2");
    	component_subscribe($$self, faqstore2, value => $$invalidate(2, $faqstore2 = value));
    	...
    	$$self.$capture_state = () => {
    		return { name, $faqstore1, $faqstore2 };
    	};

    	$$self.$inject_state = $$props => {
    		if ("name" in $$props) $$invalidate(0, name = $$props.name);
    		if ("$faqstore1" in $$props) faqstore1.set($faqstore1 = $$props.$faqstore1);
    		if ("$faqstore2" in $$props) faqstore2.set($faqstore2 = $$props.$faqstore2);
    	};
