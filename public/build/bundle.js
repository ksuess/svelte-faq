    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 50, 8, 1355);
    			add_location(label0, file, 48, 6, 1321);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 54, 8, 1458);
    			add_location(label1, file, 52, 6, 1426);
    			add_location(button, file, 56, 6, 1527);
    			add_location(div, file, 47, 4, 1293);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 40, 4, 1104);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 35, 4, 936);
    			attr_dev(button1, "class", "svelte-4qn5oh");
    			add_location(button1, file, 37, 4, 1015);
    			attr_dev(div, "class", "control svelte-4qn5oh");
    			add_location(div, file, 34, 2, 910);
    			attr_dev(li, "class", "svelte-4qn5oh");
    			add_location(li, file, 33, 0, 903);
    		},
