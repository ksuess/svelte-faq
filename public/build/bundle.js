...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 43, 6, 1166);
    			add_location(label0, file, 41, 4, 1136);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 47, 6, 1261);
    			add_location(label1, file, 45, 4, 1233);
    			add_location(button, file, 49, 4, 1326);
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				...
    				listen_dev(button, "click", /*saveFAQItem*/ ctx[5], false, false, false)
    			];
    		},
    ...
    function create_if_block(ctx) {
    	...
    	let current;
    	let dispose;
    	let if_block = /*answervisible*/ ctx[2] && create_if_block_1(ctx);
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			current = true;
    			dispose = listen_dev(h2, "click", /*toggleAnswer*/ ctx[4], false, false, false);
    		},
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*faqitem*/ 1) && t0_value !== (t0_value = /*faqitem*/ ctx[0].question + "")) set_data_dev(t0, t0_value);

    			if (/*answervisible*/ ctx[2]) {
    				if (if_block) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 30, 4, 817);
    			attr_dev(button1, "class", "svelte-4qn5oh");
    			add_location(button1, file, 31, 4, 865);
    			attr_dev(div, "class", "control svelte-4qn5oh");
    			add_location(div, file, 29, 2, 791);
    			attr_dev(li, "class", "svelte-4qn5oh");
    			add_location(li, file, 28, 0, 748);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			current = true;
    			dispose = listen_dev(button1, "click", /*click_handler*/ ctx[8], false, false, false);
    		},
    		p: function update(ctx, [dirty]) {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!li_transition) li_transition = create_bidirectional_transition(li, fade, { duration: 1000 }, true);
    				li_transition.run(1);
    			});
    		...
    		o: function outro(local) {
    			transition_out(if_block);
    			if (!li_transition) li_transition = create_bidirectional_transition(li, fade, { duration: 1000 }, false);
    			li_transition.run(0);
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	let $faqitems,
    		...
    		$$subscribe_faqitems = () => ($$unsubscribe_faqitems(), $$unsubscribe_faqitems = subscribe(faqitems, $$value => $$invalidate(7, $faqitems = $$value)), faqitems);
    	...
    	function toggleAnswer(event) {
    		$$invalidate(2, answervisible = !answervisible);
    	}
    	...
    	const click_handler = () => $$invalidate(3, editmode = !editmode);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("index" in $$props) $$invalidate(6, index = $$props.index);
    		if ("faqitems" in $$props) $$subscribe_faqitems($$invalidate(1, faqitems = $$props.faqitems));
    		if ("answervisible" in $$props) $$invalidate(2, answervisible = $$props.answervisible);
    ...
    class FAQItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { faqitem: 0, index: 6, faqitems: 1 });
    ...
    // (21:2) {#each $faqitems as faqitem, i}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(21:2) {#each $faqitems as faqitem, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 28, 2, 543);
    			attr_dev(input1, "type", "text");
