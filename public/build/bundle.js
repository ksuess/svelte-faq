...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 51, 8, 1529);
    			add_location(label0, file, 49, 6, 1495);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 55, 8, 1632);
    			add_location(label1, file, 53, 6, 1600);
    			add_location(button, file, 57, 6, 1701);
    			add_location(div, file, 48, 4, 1467);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 39, 4, 1079);
    			add_location(i, file, 41, 133, 1299);
    			attr_dev(h3, "class", "svelte-1mbf8va");
    			toggle_class(h3, "hidden", !/*answervisible*/ ctx[1]);
    			add_location(h3, file, 41, 4, 1170);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 34, 4, 911);
    			attr_dev(button1, "class", "svelte-1mbf8va");
    			add_location(button1, file, 36, 4, 990);
    			attr_dev(div, "class", "control svelte-1mbf8va");
    			add_location(div, file, 33, 2, 885);
    			attr_dev(li, "class", "svelte-1mbf8va");
    			add_location(li, file, 32, 0, 878);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$set = $$props => {
    		...
    		if ("faqitems" in $$props) $$invalidate(7, faqitems = $$props.faqitems);
    	};
    ...
    class FAQItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { faqitem: 0, index: 6, faqitems: 7 });
