...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty & /*answer*/ 2) set_data_dev(t, /*answer*/ ctx[1]);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 15, 2, 285);
    			attr_dev(li, "class", "svelte-gfcz64");
    			add_location(li, file, 14, 0, 242);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [question, answer, visible, toggleAnswer];
    }
